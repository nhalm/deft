...
- Implement closed issue compaction: on startup, remove issues with status :closed and closed_at older than issues.compaction_days (default 90); atomic JSONL rewrite; log "Compacted N closed issues older than 90 days"
