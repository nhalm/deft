...
| [web-ui](web-ui.md) | v0.8 | Implemented | Phoenix LiveView web interface, vim/tmux keybindings, responsive, real-time streaming |
...
| [orchestration](orchestration.md) | v0.16 | Implemented | Foreman/Lead/Runner hierarchy — orchestrator+agent split, OTP coordination, Deft.Store site log |
...
| [issues](issues.md) | v0.6 | Ready | Persistent issue tracker — JSONL+git, interactive creation, approve-every-plan `deft work` loop |
