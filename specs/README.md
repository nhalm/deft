...
| [sessions](sessions.md) | v0.5 | Ready | Session persistence (JSONL), resume, configuration, Mix release distribution |
| [tui](tui.md) | v0.5 | Deprecated | Terminal UI — superseded by web-ui |
| [web-ui](web-ui.md) | v0.3 | Ready | Phoenix LiveView web interface, vim/tmux keybindings, responsive, real-time streaming |
